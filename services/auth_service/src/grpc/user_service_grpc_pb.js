...
function serialize_user_GetValidatedUserRequest(arg) {
  if (!(arg instanceof user_service_pb.GetValidatedUserRequest)) {
...
function deserialize_user_GetValidatedUserRequest(buffer_arg) {
  return user_service_pb.GetValidatedUserRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_user_GetValidatedUserResponse(arg) {
  if (!(arg instanceof user_service_pb.GetValidatedUserResponse)) {
...
function deserialize_user_GetValidatedUserResponse(buffer_arg) {
  return user_service_pb.GetValidatedUserResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UserServiceService = exports.UserServiceService = {
  validateUser: {
    ...
    requestType: user_service_pb.GetValidatedUserRequest,
    responseType: user_service_pb.GetValidatedUserResponse,
